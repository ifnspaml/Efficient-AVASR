#!/bin/bash
# Local launcher: submit one Slurm job per (noise, snr, dataset) for parallel ITUT inference.
#
...
#
# Results: ${EXP_ROOT}/<exp_name>/infer_itut/{noise}/{snr}/{dataset}/
...
echo "Submitting parallel ITUT inference jobs"
...
echo "Submitted ${n_submitted} jobs. Results under ${finetune_exp_path}/${infer_root}/"
